        ...
        return [
            {
                ...
                "HORA PORTAL": row["portal_time_new"],
                "ID SUBASTA": row["id_cot"],
                "ITEM": row["id_renglon"],
                "DESCRIPCION": row["descripcion"],
                "PROVEEDOR ID": row["provider_new_id"],
                "PROVEEDOR ALIAS": row["provider_new_alias"],
                "PROVEEDOR PORTAL": row["provider_new_txt"],
                "MONTO OFERTADO TXT": row["best_offer_new_txt"],
                "MONTO OFERTADO VALOR": row["best_offer_new_val"],
                "NUEVO MINIMO TXT": row["offer_min_txt"],
                "NUEVO MINIMO VALOR": row["offer_min_val"],
