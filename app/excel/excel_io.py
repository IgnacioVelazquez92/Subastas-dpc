...
COLUMNS = [
    ...
    "MEJOR OFERTA ACTUAL",
    "ULTIMO OFERENTE ID",
    "ULTIMO OFERENTE ALIAS",
    "ULTIMO OFERENTE PORTAL",
    "OFERTA PARA MEJORAR",
    "PRECIO UNIT MEJORA",
    "RENTA PARA MEJORAR %",
    "OBS / CAMBIO",
...
FORMULAS = {
    ...
    "PRECIO DE REFERENCIA": "=[@[PRESUPUESTO OFICIAL]]*[@[ITEMS POR RENGLON]]/[@[CANTIDAD]]",
    "RENTA REFERENCIA %": "=([@[PRESUPUESTO OFICIAL]]/[@[COSTO TOTAL ARS]])-1",
    "PRECIO UNIT MEJORA": "=[@[OFERTA PARA MEJORAR]]*[@[ITEMS POR RENGLON]]/[@[CANTIDAD]]",
