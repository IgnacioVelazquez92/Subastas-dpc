...
class TableConfig:
    ...
    columns: tuple[str, ...] = (
        ...
        "id_subasta", "item", "desc", "cantidad", "items_por_renglon",
        # Metadata usuario
    ...
    def __post_init__(self):
        ...
        if self.column_tooltips is None:
            object.__setattr__(self, 'column_tooltips', {
                ...
                "desc": "DESCRIPCION",
                "cantidad": "CANTIDAD",
                "items_por_renglon": "ITEMS POR RENGLON",
                ...
                "precio_referencia": "PRESUPUESTO OFICIAL",
